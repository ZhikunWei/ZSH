...
changya_coef = pd.read_excel(r'D:\PyCharmProjects\ZSH\20211129_code\常压热值2阶组合系数.xlsx')
jianya_coef = pd.read_excel(r'D:\PyCharmProjects\ZSH\20211129_code\减压热值2阶组合系数.xlsx')
changya_fea2coef = {}
...
changya2save = changya[['时间', '燃料流量', '鼓风机变频', '燃料气热值',
                        '烟道挡板开度之和', '烟道挡板05', '烟道挡板06',
                        '烟道氧含量均值', '烟道氧含量最小值', '烟道氧含量01', '烟道氧含量02', '烟道氧含量03', '烟道氧含量04', '常压风门蝶阀开度之和']]
for i in range(1, 5):
    changya['常压风门蝶阀0%d' % i] = changya['风门蝶阀0%d' % i]
    changya2save['常压风门蝶阀0%d' % i] = changya['风门蝶阀0%d' % i]
    
jianya2save = jianya[['时间', '燃料流量', '鼓风机变频', '燃料气热值',
                      '烟道挡板开度之和', '烟道挡板03',
                      '烟道氧含量均值', '烟道氧含量最小值', '烟道氧含量01', '烟道氧含量02', '减压风门蝶阀开度之和',]]
for i in range(1, 3):
    jianya['减压风门蝶阀0%d' % i] = jianya['风门蝶阀0%d' % i]
    jianya2save['减压风门蝶阀0%d' % i] = jianya['风门蝶阀0%d' % i]

changya2save = pd.merge(changya2save, jianya[['时间', '减压风门蝶阀开度之和', '减压风门蝶阀01', '减压风门蝶阀02']], on='时间')
changya2save.to_csv('常压整理完成1207.csv', index=False, encoding='utf-8_sig')
jianya2save = pd.merge(jianya2save, changya[['时间', '常压风门蝶阀开度之和', '常压风门蝶阀01', '常压风门蝶阀02', '常压风门蝶阀03', '常压风门蝶阀04']], on='时间')
jianya2save.to_csv('减压整理完成1207.csv', index=False, encoding='utf-8_sig')
